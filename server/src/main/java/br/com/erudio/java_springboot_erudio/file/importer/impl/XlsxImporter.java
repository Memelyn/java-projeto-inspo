package br.com.erudio.java_springboot_erudio.file.importer.impl;
...
// acessa a planilha, lê cada linha e monta o RowIterator
// depois itera por cada, criando a row
// a partir da row pega cada uma das células na posição 0,1,2,3 e seta no objeto
